...
PAGES = {
    "index.html":       ("Производство упаковки из гофрокартона в Минске — " + LEGAL,
                         "Производим гофрокороба, лотки, обечайки и гофротару любой конфигурации "
    ...
    "produkciya.html":  ("Продукция — гофрокороба, лотки, обечайки, гофротара",
                         "Каталог продукции из гофрокартона: четырёхклапанные короба, лотки, обечайки, "
